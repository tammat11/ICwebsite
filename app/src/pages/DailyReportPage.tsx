...
const DailyReportPage = () => {
    ...
    const isNegativeResponse = (name: string, value: string) => {
        ...
        // Для предложений по улучшению любой ответ ("Да" или "Нет") НЕ является негативным
        // Это конструктивная связь, а не жалоба, поэтому не красим в красный и не шлем в 81 воронку
        if (name === 'improvementSuggestions') return false;

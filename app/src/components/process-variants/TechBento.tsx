    ...
    return (
        <div ref={container} className="relative py-20 px-6">
            <div className="b-header text-center mb-24 flex flex-col items-center">
                <h2 className="section-header text-brand-dark relative z-10 transition-all duration-700">
                    ...
                    <span className="relative inline-block mt-2">
                        ...
                        <div className="b-brush absolute bottom-[-10%] left-[-10%] right-[-10%] h-[120%] pointer-events-none z-0">
            ...
            <div className="b-grid max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 grid-rows-2 gap-4">
                {steps.map((s, i) => (
                    <div key={i} className={`b-card relative bg-white border border-brand-dark/[0.08] rounded-[40px] p-8 md:p-10 shadow-sm hover:shadow-2xl transition-all duration-700 z-10 flex flex-col group opacity-0 animate-fade-in-up ${s.span}`} style={{ animationDelay: `${0.1 + i * 0.1}s` }}>

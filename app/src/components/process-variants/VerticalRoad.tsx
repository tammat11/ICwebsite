            ...
            <div className="v-header text-center mb-32 flex flex-col items-center">
                <h2 className="section-header text-brand-dark relative z-10 transition-all duration-700">
                    ...
                    <span className="relative inline-block mt-2">
                        ...
                        <div className="v-brush absolute bottom-[-10%] left-[-10%] right-[-10%] h-[120%] pointer-events-none z-0">
            ...
            <div className="v-zigzag relative max-w-4xl mx-auto pb-20">
                <div className="absolute left-1/2 -translate-x-1/2 top-0 bottom-0 w-8 hidden md:block z-0">
                    <svg className="w-full h-full" viewBox="0 0 40 1000" fill="none" preserveAspectRatio="none">
                        ...
                        <path className="v-path" d="M20 1000 Q 10 900, 20 800 Q 30 700, 20 600 Q 10 500, 20 400 Q 30 300, 20 200 Q 10 100, 20 0" stroke="#83B643" strokeWidth="3" strokeDasharray="1000" strokeDashoffset="0" />
                    </svg>
                </div>
                <div className="space-y-40">
                    {steps.map((s, i) => (
                        <div key={i} className={`v-step flex items-center justify-center relative opacity-0 animate-fade-in-up ${s.side === 'left' ? 'md:justify-start' : 'md:justify-end'}`} style={{ animationDelay: `${0.15 + i * 0.12}s` }}>

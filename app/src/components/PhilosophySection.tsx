        ...
        <section ref={sectionRef} className="section-padding-compact bg-white overflow-hidden relative" id="philosophy">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 flex flex-col items-center text-center pt-24 md:pt-32">
                ...
                <div
                    ...
                    className="w-[220px] h-[220px] md:w-[320px] md:h-[320px] rounded-full overflow-hidden border-[10px] md:border-[16px] border-white shadow-[0_45px_100px_-20px_rgba(0,0,0,0.2)] mb-8 md:mb-12 relative bg-gray-50 flex-shrink-0 group"
                >
                    <img
                        src={photoPath}
                        alt="Larion Lyan"

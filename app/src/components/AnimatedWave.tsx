        ...
        <div className="relative w-full h-[10vh] min-h-[50px] max-h-[150px] overflow-hidden leading-[0] z-20">
            ...
            >
                ...
                <g className="parallax-waves">
                    <use xlinkHref="#gentle-wave" x="48" y="0" fill="rgba(143, 198, 64, 0.7)" />
                    <use xlinkHref="#gentle-wave" x="48" y="3" fill="rgba(143, 198, 64, 0.5)" />
                    <use xlinkHref="#gentle-wave" x="48" y="5" fill="rgba(143, 198, 64, 0.3)" />
                    <use xlinkHref="#gentle-wave" x="48" y="7" fill="#8fc640" />
                </g>
            </svg>
            <style>{`
                .parallax-waves > use {

                        ...
                        {steps.map((step, i) => (
                            <div key={i} className="group relative flex flex-col">
                                ...
                                <div className="mt-20 relative bg-white border border-gray-100 rounded-[40px] p-8 md:p-10 h-full min-h-[300px] flex flex-col transition-all duration-700 hover:shadow-[0_40px_100px_rgba(0,0,0,0.08)] hover:border-brand-green/30 group-hover:-translate-y-3">
                                    ...
                                    {/* Elevated Icon */}
                                    <div className="mb-10 w-20 h-20 bg-gray-50 rounded-[28px] flex items-center justify-center text-brand-dark shadow-sm transition-all duration-500 group-hover:bg-brand-green group-hover:text-white group-hover:shadow-[0_20px_40px_rgba(131,182,67,0.3)] group-hover:scale-110 group-hover:rotate-6">

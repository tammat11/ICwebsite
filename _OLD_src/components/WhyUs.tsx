            ...
            <div className="relative w-full group">
                ...
                >
                    {infiniteReasons.map((reason, i) => (
                        ...
                        >
                            <div className="group/card relative overflow-hidden rounded-[40px] border border-black/[0.04] bg-brand-light h-[320px] md:h-[620px] transition-all duration-700 hover:border-brand-green/30 hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.08)] flex flex-col justify-between p-6 md:p-14 whitespace-normal">
                                <div className={`w-12 h-12 md:w-24 md:h-24 rounded-[28px] ${reason.accent} flex items-center justify-center text-brand-green mb-4 md:mb-8 transition-all duration-700 group-hover/card:scale-110 group-hover/card:bg-brand-green group-hover/card:text-white relative z-20`}>
                                    {reason.icon}
                                </div>

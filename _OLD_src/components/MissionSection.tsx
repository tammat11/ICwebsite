    ...
    return (
        <section ref={sectionRef} className="bg-white relative overflow-hidden" id="mission">
                ...
                <div className="w-full lg:w-1/3 mission-title-container">
                    <div className="mission-title-sticky pt-10">
                        ...
                        <div className="space-y-6 max-w-full lg:max-w-[240px]">
                            <p className="text-sm font-medium text-black/40 uppercase tracking-tight leading-snug">
                            ...
                            <div className="flex items-center gap-3 text-brand-green group cursor-pointer">
                                <span className="text-[10px] font-bold uppercase tracking-widest">Manifesto 2025</span>
                ...
                <div className="w-full lg:w-2/3 space-y-16 md:space-y-32 relative">
                    ...
                    <div className="mission-block-entry relative pl-0 lg:pl-10">
                        ...
                        <div className="relative z-10">
                            <div className="w-12 h-12 rounded-[28px] md:w-16 md:h-16 md:rounded-[28px] bg-brand-green/10 flex items-center justify-center text-brand-green mb-6 md:mb-10 shadow-sm border border-brand-green/10">
                            ...
                            <p className="text-xl md:text-3xl font-medium text-black/30 leading-[1.1] max-w-xl">
                                Создавать безупречную чистоту, которая повышает качество жизни и работы наших клиентов.
                            </p>
                            <div className="mt-12 flex items-center gap-4 text-[10px] font-bold uppercase tracking-[0.3em] text-brand-green">
                                <ShieldCheck size={16} />
                    ...
                    <div className="mission-block-entry relative pl-0 lg:pl-10">
                        ...
                        <div className="relative z-10">
                            <div className="w-12 h-12 rounded-[28px] md:w-16 md:h-16 md:rounded-[28px] bg-[#7B85A7]/10 flex items-center justify-center text-[#7B85A7] mb-6 md:mb-10 shadow-sm border border-[#7B85A7]/10">
                            ...
                            <div className="mt-12 p-6 md:p-8 bg-slate-50 border border-black/5 rounded-[40px] max-w-md">
                                <div className="flex items-center gap-4 mb-4">
                                    <Zap size={18} className="text-brand-green" />
                                    <span className="text-xs font-bold uppercase tracking-widest text-brand-dark">Focus 2030</span>
                                </div>
                    ...
                    <div className="mission-block-entry relative pl-0 lg:pl-10 pb-20">
                        ...
                        <div className="relative z-10">
                            <div className="w-12 h-12 rounded-[28px] md:w-16 md:h-16 md:rounded-[28px] bg-brand-dark/10 flex items-center justify-center text-brand-dark mb-6 md:mb-10 shadow-sm border border-brand-dark/10">
            ...
            <div className="absolute bottom-0 right-0 p-12 opacity-[0.03] select-none pointer-events-none">
                <span className="text-[10vh] md:text-[20vh] font-[1000] uppercase tracking-tighter leading-none">MANIFESTO</span>
            </div>
        </section>
    );
};

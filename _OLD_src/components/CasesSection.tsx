                    ...
                    {cases.map((item, i) => (
                        ...
                        >
                            ...
                            <div className="w-full md:w-3/5 shrink-0">
                                <div className="relative h-[220px] md:h-[380px] rounded-[40px] overflow-hidden border border-black/[0.05] shadow-sm group-hover:shadow-2xl transition-all duration-700">

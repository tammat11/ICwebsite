            ...
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="benefit-cards-grid grid grid-cols-1 sm:grid-cols-12 gap-4 md:gap-10">
                    ...
                    <div className="bento-card col-span-1 sm:col-span-7 group relative">
                        <div className="h-full bg-slate-50 border border-black/[0.04] rounded-[40px] p-5 md:p-10 flex flex-col justify-between overflow-hidden relative shadow-sm hover:shadow-xl hover:bg-white transition-all duration-700">
                            <div className="relative z-10 max-w-sm">
                                <div className="w-16 h-16 rounded-[28px] bg-brand-green/10 flex items-center justify-center text-brand-green mb-8 group-hover:rotate-12 transition-transform">
                    ...
                    <div className="bento-card col-span-1 sm:col-span-5 group relative h-[220px] md:h-[350px]">
                        <div className="h-full bg-brand-dark rounded-[40px] p-5 md:p-10 flex flex-col justify-between overflow-hidden relative shadow-2xl transition-all duration-700 hover:scale-[1.02]">
                    ...
                    <div className="bento-card col-span-1 sm:col-span-5 group relative h-[220px] md:h-[350px]">
                        <div className="h-full bg-white border border-black/[0.04] rounded-[40px] p-5 md:p-10 flex flex-col justify-between overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-1000">
                            <div className="relative z-10">
                                <div className="w-16 h-16 rounded-[28px] bg-brand-secondary/10 flex items-center justify-center text-brand-secondary mb-10">
                            ...
                            <div className="mt-8 flex items-center gap-4 p-4 bg-slate-50 rounded-[28px] border border-black/[0.02]">
                    ...
                    <div className="bento-card col-span-1 sm:col-span-7 group relative h-[220px] md:h-[350px]">
                        <div className="h-full bg-slate-50 border border-black/[0.04] rounded-[40px] p-5 md:p-10 flex flex-col md:flex-row items-center gap-6 md:gap-8 overflow-hidden relative shadow-sm hover:shadow-xl hover:bg-white transition-all duration-700">
                            ...
                            <div className="flex-1 w-auto h-full flex items-end justify-end gap-2 md:gap-4 opacity-40 group-hover:opacity-100 transition-opacity duration-700">
                                {[0.3, 0.5, 0.4, 0.7, 0.6, 1, 0.9].map((h, i) => (
                                    <div key={i} className="w-5 md:w-8 bg-black/[0.05] rounded-t-full relative overflow-hidden" style={{ height: (h * 60) + '%' } as React.CSSProperties}>
                                        <div className="absolute bottom-0 left-0 w-full bg-brand-green" style={{ height: (h * 100) + '%' } as React.CSSProperties} />
                                    </div>
                                ))}
                            </div>
                        </div>

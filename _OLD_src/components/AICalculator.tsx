                                    ...
                                    <div className="grid grid-cols-1 gap-3 max-w-md mx-auto w-full">
                                        {[
                                            ...
                                            <button
                                                ...
                                                className={`group relative flex items-center justify-between p-7 rounded-[40px] border-2 transition-all hover:translate-x-1 ${type === item.id ? 'border-black bg-black text-white' : 'border-black/5 bg-gray-50 hover:border-black/20 text-black/40'}`}
                                            >
                                                <div className="flex items-center gap-6">
                                                    <div className={`w-14 h-14 rounded-[28px] flex items-center justify-center transition-all ${type === item.id ? 'bg-brand-green text-white' : 'bg-white text-black/20'}`}>
                                                        {item.icon}
                                                    </div>
                                            ...
                                            <div className="grid grid-cols-3 gap-2">
                                                {Object.entries(chemMap).map(([key, val]) => (
                                                    <button
                                                        ...
                                                        className={`py-4 rounded-[28px] border-2 font-black text-[10px] uppercase tracking-widest transition-all flex flex-col items-center gap-2 ${chemistry === key ? 'bg-black text-white border-black shadow-lg' : 'bg-gray-50 border-black/5 text-black/30 hover:border-black/20'}`}
                                                    >
                                                        {val.icon}
                                                        {val.label}
                                                    </button>
                            ...
                            {step === 4 && (
                                <div className="space-y-12 py-10">
                                    ...
                                    <div className="grid grid-cols-2 gap-3 max-w-sm mx-auto">
                                        <div className="bg-gray-50 p-6 rounded-[40px] border border-black/5 flex flex-col gap-2 group hover:bg-white transition-colors">

...
const AdminPage = () => {
                ...
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-white rounded-[40px] p-8 md:p-12 shadow-xl border border-black/5">
                        <div className="text-center mb-8">
                            <div className="w-16 h-16 rounded-[28px] bg-brand-green/10 flex items-center justify-center mx-auto mb-4">
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-5 py-4 bg-brand-light rounded-[28px] border border-black/5 text-lg font-bold focus:outline-none focus:ring-2 focus:ring-brand-green/30"
                                    />
                                </div>
                                <button
                                    onClick={sendCode}
                                    disabled={authLoading || !phone}
                                    className="w-full flex items-center justify-center gap-3 bg-brand-dark text-white py-4 rounded-[28px] font-bold uppercase text-sm tracking-widest hover:bg-brand-green transition-all disabled:opacity-50"
                                >
                            ...
                            <div className="space-y-4">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="000000"
                                        maxLength={6}
                                        className="w-full px-5 py-4 bg-brand-light rounded-[28px] border border-black/5 text-3xl font-bold tracking-[0.5em] text-center focus:outline-none focus:ring-2 focus:ring-brand-green/30"
                                    />
                                </div>
                                <button
                                    onClick={verifyCode}
                                    disabled={authLoading || code.length !== 6}
                                    className="w-full flex items-center justify-center gap-3 bg-brand-green text-white py-4 rounded-[28px] font-bold uppercase text-sm tracking-widest hover:bg-brand-dark transition-all disabled:opacity-50"
                                >
                        ...
                        {authError && (
                            <div className="mt-4 p-4 bg-red-50 border border-red-200 rounded-[28px] text-sm text-red-600 font-medium text-center">
                                {authError}
                            </div>
                        )}
                    </div>
    ...
    if (editingArticle) {
        return (
            <div className="min-h-screen bg-brand-light px-4 py-8 pt-32 md:pt-40">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="bg-white rounded-[40px] p-8 md:p-10 shadow-xl border border-black/5 space-y-6">
                        {/* Image */}
                        <div>

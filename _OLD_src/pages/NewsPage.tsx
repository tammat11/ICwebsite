                ...
                <div className="max-w-7xl mx-auto">
                    ...
                    <div className="news-grid grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
                        {articles.map((article) => (
                            <div key={article.id} className="news-card group rounded-[40px] bg-white border border-black/[0.03] hover:shadow-glass hover:border-brand-green/30 transition-all duration-700 overflow-hidden flex flex-col relative">
                    ...
                    {/* CTA Footer */}
                    <div className="mt-20 p-10 md:p-16 rounded-[40px] bg-brand-green relative overflow-hidden text-center shadow-2xl shadow-brand-green/40">
